...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    protected void setUpView() {
    	FriendItemEntity entity = FriendsManager.getInstance().getFrinedInfo(toChatUsername);
    	if(null != entity){
    		titleBar.setTitle(entity.getFans().getAlias());
    	}else{
    		if("ppstar".equals(toChatUsername)){
    			titleBar.setTitle(getString(R.string.app_kefu));
    		}else{
...
//                    toGroupDetails();
    ...
    public void onEvent(EMNotifierEvent event) {
        ...
        case EventNewCMDMessage:{
        	...
        	if(null != chatFragmentListener && !DemoHelper.getInstance().isVideoCalling && !DemoHelper.getInstance().isVoiceCalling){
