...
import com.intexh.bidong.easemob.dao.DemoDBManager;
import com.intexh.bidong.easemob.dao.InviteMessgeDao;
import com.intexh.bidong.easemob.dao.UserDao;
import com.intexh.bidong.easemob.domain.InviteMessage;
import com.intexh.bidong.easemob.domain.InviteMessage.InviteMesageStatus;
...
//		DemoHelper.getInstance().logout(false, null);
		...
		broadIntent.setAction(BaseActivity.FINISH_ALL);
		appContext.sendBroadcast(broadIntent);
        ...
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                case EventNewCMDMessage: {
                    ...
                    int msgType = message.getIntAttribute("type",-1);
                    if(null != UserUtils.getUserid()){
                    	switch(msgType){
                            case Constants.MessageType.MessageType_FANS_ADD:
                            case Constants.MessageType.MessageType_FANS_ACTIVE:
                            case Constants.MessageType.MessageType_FANS_BLOCK:
                            case Constants.MessageType.MessageType_FANS_DELETE:{
