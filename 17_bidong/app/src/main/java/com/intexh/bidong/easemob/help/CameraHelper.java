...
public class CameraHelper implements PreviewCallback {
    ...
    public void startFaceCamera(){
    	...
    	try {
            ...
            Log.e("frank","supportedPreviewSizes="+supportedPreviewSizes);
    ...
    boolean isScreenOriatationPortrait() {
        return PPStarApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
