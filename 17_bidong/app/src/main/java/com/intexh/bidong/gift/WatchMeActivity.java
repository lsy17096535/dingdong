 ...
 */
public class WatchMeActivity extends BaseTitleActivity {
    ...
    private WatchMeAdapter adapter = null;
    ...
    private View.OnClickListener recordListener = new View.OnClickListener() {
        ...
        public void onClick(View arg0) {
            Intent intent = new Intent(WatchMeActivity.this, MyTrendVideoActivity.class);
    ...
    private void getDatas(){
        GetWatchMeRequest request = new GetWatchMeRequest();
    ...
    private void getUserDetail(final WatchItemEntity entity){
        ...
        request.setNetworkListener(new CommonAbstractDataManager.CommonNetworkCallback<User>() {
            ...
            public void onSuccess(User data) {
                ...
                Intent intent = new Intent(WatchMeActivity.this, UserDetailActivity.class);
