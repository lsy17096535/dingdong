...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.img_loading;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.img_loading);
		...
		if (uri != null && new File(uri.getPath()).exists()) {
			...
			bitmap = null;
			if (bitmap == null) {
				com.intexh.bidong.utils.ImageUtils.loadSnapshotDefaultImage("file:///" + uri.getPath(), image);
