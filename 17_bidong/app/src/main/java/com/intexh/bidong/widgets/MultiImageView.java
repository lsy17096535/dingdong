...
import com.intexh.bidong.utils.DensityUtil;
...
public class MultiImageView extends LinearLayout {
    ...
    public void setList(List<String> lists) throws IllegalArgumentException {
        ...
        imagesList = lists;
        Log.d("TREND", lists.get(0).toString());
        if (MAX_WIDTH > 0) {
...
//                ImageLoader.getInstance().displayImage(url, imageView);
                ImageUtils.loadSnapshotSmallImage(url, imageView, 0.7f);
...
//                    ImageLoader.getInstance().displayImage(thumbUrl, imageView);
                    ...
                    ImageUtils.loadSnapshotSmallImage(thumbUrl, imageView, 0.7f);
